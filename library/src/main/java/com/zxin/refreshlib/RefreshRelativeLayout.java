...
import com.zxin.refreshlib.DefaultNegativeRefreshers.HorizontalLoadMore;
import com.zxin.refreshlib.DefaultNegativeRefreshers.NegativeRefresherWithNodata;
import com.zxin.refreshlib.DefaultPositiveRefreshers.HorizontalProgressWithArrow;
import com.zxin.refreshlib.DefaultPositiveRefreshers.OverlayProgressWithArrow;
import com.zxin.refreshlib.DefaultPositiveRefreshers.PositiveRefresherWithText;
import com.zxin.refreshlib.support.ViewScrollHelper.IViewScrollHelper;
import com.zxin.refreshlib.support.ViewScrollHelper.ViewScrollHelper;
import com.zxin.refreshlib.support.ViewAnimateHelper;
...
public class RefreshRelativeLayout extends RelativeLayout implements NestedScrollingParent,NestedScrollingChild{
    ...
    public boolean getNegativeEnable(){
        return negativeEnable;
    }
    ...
    public void setProgressColor(int color){
        if (color!=-1&&mPositiveRefresher!=null)
            mPositiveRefresher.setProgressColor(color);
    }
    ...
    private synchronized void showUpRefresher(){
        ...
        if(positiveOverlayUsed){
            if(!isOverlayUpRefresherShowing()){
                mViewAnimateHelper.delaySmoothTranslateY(mPositiveRefreshView, (int) mPositiveRefresher.getOverlayOffset(),duration,0,true,mPositiveRefresher,getPositiveAnimEndListener());
            }
        }else if(!isUnoverlayoutUpShowing()){
            mViewAnimateHelper.delayScrollToYWithRefer(this,mPositiveRefreshView,-mPositiveRefresher.getOverlayOffset(),true,duration,0,mPositiveRefresher,getPositiveAnimEndListener());
        }
    }
    ...
    private synchronized void showDownRefresher(){
        ...
        if(negativeOverlayUsed){
            if(!isOverlayDownRefresherShowing()){
                mViewAnimateHelper.delaySmoothTranslateY(mNegativeRefreshView, (int) -mNegativeRefresher.getOverlayOffset(),duration,0,false,mNegativeRefresher,getNegativeAnimEndListener());
            }
        }else if(!isUnoverlayDownShowing()){
            mViewAnimateHelper.delayScrollToYWithRefer(this,mNegativeRefreshView,mNegativeRefresher.getOverlayOffset(),false,duration,0,mNegativeRefresher,getNegativeAnimEndListener());
        }
    }
    ...
    private synchronized void showLeftRefresher(){
        ...
        if(positiveOverlayUsed){
            if(!isOverlayLeftRefresherShowing()){
                mViewAnimateHelper.delaySmoothTranslateX(mPositiveRefreshView, (int) mPositiveRefresher.getOverlayOffset(),duration,0,true,mPositiveRefresher,getPositiveAnimEndListener());
            }
        }else{
            mViewAnimateHelper.delayScrollToXWithRefer(this,mPositiveRefreshView,-mPositiveRefresher.getOverlayOffset(),true,duration,0,mPositiveRefresher,getPositiveAnimEndListener());
        }
    }
    ...
    private synchronized void showRightRefresher(){
        ...
        if(negativeOverlayUsed){
            if(!isOverlayRightRefresherShowing()){
                mViewAnimateHelper.delaySmoothTranslateX(mNegativeRefreshView, -(int) mNegativeRefresher.getOverlayOffset(),duration,0,false,mNegativeRefresher,getNegativeAnimEndListener());
            }
        }else if(!isUnoverlayRightShowing()){
            mViewAnimateHelper.delayScrollToXWithRefer(this,mNegativeRefreshView,mNegativeRefresher.getOverlayOffset(),false,duration,0,mNegativeRefresher,getNegativeAnimEndListener());
        }
    }
